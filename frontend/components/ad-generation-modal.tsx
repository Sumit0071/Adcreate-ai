...
export function AdGenerationModal({ businessProfile, onClose }: AdGenerationModalProps) {
      ...
      const parsedAds: AdSequence[] = adsArray.map(
        (ad: { id: number; content: string; imageUrl: string | null; generatedAt: string }, idx: number) => {
          ...
          return {
            ...
            style: "Generated",
            ctr: (ad as any).ctr, // Getting CTR from backend
          };
        }
      );
    ...
    return (
      ...
      >
        <Dialog open={true} onOpenChange={onClose}>
          <DialogContent className={`!max-w-5xl !w-full max-h-[95vh] overflow-y-auto ${theme === "dark"
            ? "bg-gradient-to-bl from-gray-800 via-gray-900 to-slate-950 text-white"
            : "bg-gradient-to-bl from-white via-blue-50 to-pink-100"
            }`}>
            <DialogHeader>
                        ...
                        <div className="space-y-4">
                          ...
                          >
                            <div className="relative">
                              <img
                                src={ad.imageUrl ? `${BACKEND_URL}${ad.imageUrl}` : "/placeholder.svg"}
                            ...
                            <CardContent className="pt-4">
                              ...
                              <div className="grid grid-cols-2 gap-4 text-sm">
                                <div>
                                  ...
                                  <span className="font-medium ml-1">{ad.ctr || "2.8%"}</span>
                                </div>
                                <div>
  ...
  return (
    ...
    >
      <Dialog open={true} onOpenChange={onClose}>
        <DialogContent className={`max-w-2xl ${theme === "dark"
          ? "bg-gradient-to-bl from-gray-800 via-gray-900 to-slate-950 text-white"
          : "bg-gradient-to-bl from-white via-blue-50 to-pink-100"
          }`}>
          <DialogHeader>
